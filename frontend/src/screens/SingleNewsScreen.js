...
import { listSingleNews ,listAllNews,reset1,reset3,addDislike2,addLike2,getDayNews,NewsAddCommnet} from '../features/news/newsSlice'
  ...
  return (
    ...
    <Row>
        ...
        <ListGroup variant='flush'>
            <ListGroup.Item >
            <Image src={singleNews.image} alt={singleNews.titre}  fluid/>
            <div>
        {singleNews.auteur && singleNews.auteur.nom} : "crée le {singleNews.createdAt && formaterDate(singleNews.createdAt)} ,modifée le {singleNews.updatedAt &&formaterDate( singleNews.updatedAt)}"
            ...
            <ListGroup.Item>
            <h3 style={{ fontWeight:'bold',whiteSpace:'pre-line'}}>
                {singleNews.description}
            </h3>
           </ListGroup.Item>
           <ListGroup.Item>
          <p style={{fontSize:"20px",whiteSpace:'pre-line'}}>{ singleNews.plusInformation}</p> 
          </ListGroup.Item>
          <ListGroup.Item>
